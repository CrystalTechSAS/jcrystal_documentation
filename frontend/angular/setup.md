...
The generated code of jCrystal must be added in the folder: `src/app` of your Angular application. You can copy-paste the generated folder directly on `src/app` or if you have access to the backend project, you can set the output folder of this client to your the `src/app` folder of your Angular project. 
